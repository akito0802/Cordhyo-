...
const PLAY_VOICINGS={
'69':[0,4,9,14],m69:[0,3,9,14],add9:[0,4,14],madd9:[0,3,14],add11:[0,4,17],add13:[0,4,21],madd11:[0,3,17],madd13:[0,3,21],
'9':[0,4,10,14],maj9:[0,4,11,14],m9:[0,3,10,14],'11':[0,10,17],maj11:[0,4,11,17],m11:[0,3,10,17],
'13':[0,4,10,21],maj13:[0,4,11,21],m13:[0,3,10,21],maj9s11:[0,4,11,18],
'7b9':[0,4,10,13],'7s9':[0,4,10,15],'7b13':[0,4,10,20],'7s11':[0,4,10,18],'7b5b9':[0,4,6,13],'7s5s9':[0,4,8,15],'7b9s11':[0,4,10,13,18],'13b9':[0,4,10,13,21],'13s11':[0,4,10,18,21],'7alt':[0,4,10,13,15],
m7b9:[0,3,10,13],dimadd9:[0,3,6,14],'9sus4':[0,5,10,14],sus4add9:[0,5,14]
};
...
playChordButton.addEventListener('click',()=>{const root=NOTES.indexOf(rootEl.value),formula=PLAY_VOICINGS[typeEl.value]||FORMULAS[typeEl.value],bass=bassEl.value==='none'?null:NOTES.indexOf(bassEl.value);if(bass!==null)playMidi(48+bass,1.1,0);formula.forEach((interval,index)=>{playMidi(60+root+interval,1,bass!==null?.06+index*.035:index*.035);setTimeout(()=>flashPitchClass((root+interval)%12),index*35);});});
